  ...
  const nodes = hierarchyNodes.map(n => {
    ...
    return {
      data: {
        ...
        bottleneck_tightness_index_v3: bti,
        bottleneck_tightness_tier_v3: tier,
        ...
        bti_dimensions: panel.bti_dimensions || null,
        bti_dimension_scores: panel.bti_dimension_scores || null,
        research_date: panel.research_date || '',
  ...
  const nodes = gNodes.map(n => {
    ...
    return {
      data: {
        ...
        bottleneck_tier: tier,
        bottleneck_tightness_index_v3: tightnessIndex,
        bottleneck_tightness_tier_v3: tier,
